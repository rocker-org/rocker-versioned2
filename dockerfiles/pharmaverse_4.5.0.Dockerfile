...
ENV CRAN="https://p3m.dev/cran/__linux__/noble/2024-11-30"
...
COPY scripts/install_pharmaverse.sh /rocker_scripts/install_pharmaverse.sh
RUN /rocker_scripts/install_pharmaverse.sh
